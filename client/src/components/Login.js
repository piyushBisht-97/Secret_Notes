...
<p>You dont have an account <span onClick={()=> setOnLogin(true)}>Register Now</span></p>
<h3>{err}</h3>
</form>
 </div>
...
<input type="text" name="name" id="register-email"  placeholder="Username"  required value={user.name} onChange={onChangeInput}/>
